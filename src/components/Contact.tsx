            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground font-medium">Montréal, Québec</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  name="service"
                  required
                  className="w-full h-10 rounded-lg bg-secondary/50 border border-border px-3 text-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                >
              ...
              <div>
                ...
                <Textarea
                  ...
                  required
                  rows={4}
                  placeholder="Parlez-nous de votre entreprise et de vos objectifs..."
