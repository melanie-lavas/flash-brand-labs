...
const steps = [
  {
    ...
    description: "On discute de votre projet, vos objectifs et vos besoins. Aucun engagement.",
  },
  {
    icon: Lightbulb,
    step: "02",
    title: "Proposition sur mesure",
    description: "Nous préparons une soumission détaillée adaptée à votre budget et vos attentes.",
  },
  {
    icon: Rocket,
    step: "03",
    title: "Réalisation",
    description: "Notre équipe se met au travail. Vous êtes informé à chaque étape du processus.",
  },
  {
    icon: ThumbsUp,
    step: "04",
    title: "Livraison et suivi",
    description: "Votre projet est livré et nous restons disponibles pour tout ajustement.",
  },
];
          ...
          {steps.map((item, index) => (
            ...
            >
              ...
              <div className="relative inline-flex">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mb-4 mx-auto">
